...
*/
          ...
          //k: nombre d'experiences
          //System.out.print(colors+" couleurs " +pieces+" pions \r\n\r\n");
          //for(int k=0;k<pieces;k++)
          //{
          //int[] solution=new int[pieces];
          //System.out.print("Combinaison No " + k + ": ");
             //j: nombre de pions
             for(int j=0;j<pieces;j++)
             {
             //solution[j]= new mastermind().random(colors);
             //System.out.print(solution[j]+ " ");
			 //System.out.print(new mastermind().convertn2c(solution[j])+ " ");
             }
          //System.out.println("\r\n");
		...
		{
		//System.out.print(pCour.couleurs[c]);
		//System.out.print(new mastermind().convertn2c(pCour.couleurs[c])+" ");
		result[nNbEssais][c]=pCour.couleurs[c];
		}
		//System.out.print(" Noirs: "+pCour.nNbNoirs+" Blancs: "+pCour.nNbBlancs+"\r\n");
		//System.out.print("\r\n");
		bFini=(pCour.nNbNoirs==pieces ? 1 : 0);
		 ...
		 System.out.print("Mastermind resolu en "+ nNbEssais+" coups\n\n");
			//System.out.println(new mastermind().convertn2c(1999));
